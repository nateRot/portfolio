...
class RNNTrainer(Trainer):
    ...
    def train_epoch(self, dl_train: DataLoader, **kw):
        ...
        # ====== YOUR CODE: ======
        self.h = torch.zeros((dl_train.batch_size, self.model.n_layers, self.model.h_dim), requires_grad=True, device=self.device)
        # raise NotImplementedError()
        # ========================
    ...
    def test_epoch(self, dl_test: DataLoader, **kw):
        # TODO: Implement modifications to the base method, if needed.
        # ====== YOUR CODE: ======
        self.h = torch.zeros((dl_test.batch_size, self.model.n_layers, self.model.h_dim), device=self.device)
        # raise NotImplementedError()
        # ========================
...
class VAETrainer(Trainer):
    def train_batch(self, batch) -> BatchResult:
        ...
        # ====== YOUR CODE: ======
        x_out, mu, sig = self.model(x)
        loss, data_loss, _kl_Loss = self.loss_fn(x, x_out, mu, sig)
